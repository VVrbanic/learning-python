...
def celsius_to_fahrenheit(temp):
    newTem= (9/5)*temp+32
    print ("The Celsius temperature",temp, "is equivalent to", newTem, "degrees Fahrenheit.")
...
def inches_to_feet2(inches):
    feet = inches//12
    exstra_inches = inches % 12
    print(inches,"inches is", feet, "feet and", exstra_inches, "inches")
